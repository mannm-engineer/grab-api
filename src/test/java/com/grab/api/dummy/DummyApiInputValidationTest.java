...
@ApiUnitTest(controllers = DummyApiInputValidationTest.DummyRestController.class)
/*
 * @ApiUnitTest(controllers = ...) only filters the component scan; it does not add classes to the
 * context. Since DummyRestController is a nested class inside this test, it falls outside Spring's
 * scan path entirely. @Import is required to explicitly register it — without it, the controller
 * is never loaded and requests return 404.
 */
@Import(DummyApiInputValidationTest.DummyRestController.class)
