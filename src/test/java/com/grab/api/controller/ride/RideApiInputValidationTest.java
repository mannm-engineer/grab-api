...
class RideApiInputValidationTest {
  ...
  static Stream<Arguments> createRide_notBlankFieldScenarios() {
    return Stream.of(
        Arguments.of(
            "missing",
            // language=JSON
  ...
  @MethodSource("createRide_notBlankFieldScenarios")
  void createRide_notBlankField_responseBadRequest(String scenario, String requestBody)
      throws Exception {
    mockMvc
        .perform(post("/rides")
  ...
  static Stream<Arguments> createRide_notNullFieldScenarios() {
    return Stream.of(
        Arguments.of(
            "missing",
            // language=JSON
  ...
  @ParameterizedTest(name = "{0}")
  @MethodSource("createRide_notNullFieldScenarios")
  void createRide_notNullField_responseBadRequest(String scenario, String requestBody)
      throws Exception {
    mockMvc
        .perform(post("/rides")
            .contentType(MediaType.APPLICATION_JSON)
